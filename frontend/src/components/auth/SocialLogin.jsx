export default function SocialLogin() {
  return (
    <>
      ...
      {/* Social login */}
      <button className="btn-sm text-white bg-gradient-to-t from-secondary to-secondaryDark hover:to-secondary w-full relative flex after:flex-1">
        <div className="flex-1 flex items-center">
          <svg className="w-4 h-4 fill-current text-secondaryLight shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="flex-auto text-amber-50 pl-3">Continue With Google</span>
      </button>
    </>
  )
}